...
thumbs = [f"https://i.ytimg.com/vi/{d['id']}/maxresdefault.jpg" for d in data]
...
replace_array('fakeTitles', json.dumps(titles).replace('"', "'"))
replace_array('fakeChannels', json.dumps(channels).replace('"', "'"))
replace_array('fakeViews', json.dumps(views).replace('"', "'"))
replace_array('fakeAges', json.dumps(ages).replace('"', "'"))
replace_array('fakeDurs', json.dumps(durs).replace('"', "'"))
replace_array('fakeThumbs', json.dumps(thumbs).replace('"', "'"))
replace_array('fakeDescs', json.dumps(descs).replace('"', "'"))
